...
- [ ] **[F2.6]** `P0` **Testar o login Google de ponta a ponta em aparelho real** — instalar o `.apk`, tocar em "Continuar com Google", ver o seletor nativo, entrar, e confirmar que salva no Firestore. _(depende de: F2.4 ✅)_
