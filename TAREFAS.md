...
- [ ] **[B10.3]** Ícone do aplicativo na tela do Android ainda usa a arte antiga com fundo branco — refazer ícone adaptativo (primeiro plano + fundo) com o símbolo novo.
...
- [ ] **[B12.7]** **André:** publicar o `firestore.rules` novo (origem `movimento`, campos `activity` e `tags`) e criar o índice do `wall` (status ↑, lang ↑, source ↑, createdAt ↓). Sem isso o envio de histórias é recusado e a lista não carrega.
