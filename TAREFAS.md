...
- [ ] **[B6.1]** Auditoria de usabilidade: pontos de confusão, telas longas, caminhos duplicados.
- [ ] **[B6.2]** Direção visual "traços finos, calmos e modernos" — mockup para aprovação antes de aplicar.
- [ ] **[B6.3]** Aplicar no app inteiro após aprovação.
